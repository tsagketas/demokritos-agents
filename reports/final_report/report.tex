...
\item \eng{exploitability(strategy, game, player\_id)}: Υπολογίζει το best response απέναντι στη στρατηγική, βρίσκει το αναμενόμενο payoff της best response, αφαιρεί το αναμενόμενο payoff της τρέχουσας στρατηγικής. Μεγάλη exploitability = η στρατηγική είναι εύκολα εκμεταλλεύσιμη.
...
\caption{Heatmap exploitability για διάφορες παραμέτρους. Υψηλές τιμές δείχνουν ότι οι learned στρατηγικές απέχουν από το NE.}
\end{figure}
